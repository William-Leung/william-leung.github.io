    ...
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <section className="mb-10">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed mb-4">
          ...
          between trauma exposure and BPD features.
        </p>
        <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed mb-4">
          This grounds BPD symptomatology in{' '}
          <strong className="text-gray-700 dark:text-gray-300">trauma rather than inherent
          personality defect</strong>. The symptoms represented by each dot are better understood
          as responses to harm — not character flaws.
        </p>
        <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
      ...
      <section className="mb-8">
        ...
        <p className="text-xs text-gray-400 dark:text-gray-500 leading-relaxed">
          Kaehler, L. A., &amp; Freyd, J. J. (2012). Borderline personality characteristics: A
          betrayal trauma approach.{' '}
          <em>Psychological Trauma: Theory, Research, Practice, and Policy, 4</em>(4), 379–385.
        </p>
      </section>
